...
public class SceneControlManager : MonoBehaviour
{
    ...
    DefineHelper._eSceneIndex _prevScene;
    ...
    {
        GameObject go = Instantiate(ResourcePoolManager.instance.GetUIPrefabFromType(DefineHelper.eUIwindowtype.LoaddingWnd), transform);
        ...
        {
            InGameManager._instance.InitializeSettings(MainSceneManager._instance._eInagemeDifficult);
        }
