...
public class OptionWnd : MonoBehaviour
{
    ...
    public void SoundSeting()
    {
        ...
        optionInfo.Add("Bgm", _bgmBar.value.ToString());
        optionInfo.Add("Sfx", _sfxBar.value.ToString());
        optionInfo.Add("BgmMute", Mute.ToString());
        optionInfo.Add("SfxMute", SfxMute.ToString());
    }
    ...
    public void ClilckOkButton()
    {
        ...
        optionInfo.Add("BgmMute", Mute.ToString());
        optionInfo.Add("SfxMute", SfxMute.ToString());
        UserInfoManager.instance.OptionSave(optionInfo);
        UserInfoManager.instance.OptionLoad();
